...
<div class="flex justify-center items-center mb-4">
  <div style="position:fixed; left:0px; bottom:0px; width:100%; ">
    ...
    <div style="display:flex;justify-content:center;align-items:center;background-color:black;height: 50px;">
      ...
      <a target="_blank" href="http://beian.miit.gov.cn/"
         style="display:inline-block;text-decoration:none;height:20px;line-height:20px;" rel="noopener">
        <b style="color:white; margin-left: 10px;"> 湘ICP备2022015195号</b>
      </a>
    </div>
  </div>
</div>
